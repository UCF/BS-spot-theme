jQuery(document).ready( function($) {
	...
	// options = $.extend( {}, default_options, options ); /* Merge Options Objects */
			...
			var the_html = '<div class="info-box-wrapper">';
				...
				the_html += '<div class="body">';
					...
					the_html += '<div class="address-container">';
						...
						the_html += '<div class="address">106 Aquarius Agora Drive<br />Orlando, FL 32816</div>';
					the_html += '</div>';
	...
	function make_JTWC_marker() {
		...
		var JTWC_coords = new google.maps.LatLng( 85.04593933196735, -179.95878338988405 ),
			...
			image_link = SPRY.themeUrl + '/library/images/1.png';
